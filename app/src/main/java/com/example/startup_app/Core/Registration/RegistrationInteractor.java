...
public class RegistrationInteractor implements RegistrationContract.Intractor {
    ...
    @Override
    public void performFirebaseStudentRegister(Activity activity, String email, String password, final String name, final String phoneNumber, final String grade) {
    ...
    @Override
    public void performFirebaseTeacherRegister(Activity activity, String email, String password, final String name, final String phoneNumber, final String subjects) {
